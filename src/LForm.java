...
public class LForm extends TetrisForm {
    private int position=0;
    
    
    public LForm(byte size) {
        //super(Color.blue, size);
        super(4, size);
    }
    
    public void setLLocation(int rotate, int x, int y){
        switch(rotate){
            case 0:
                rotate0(x, y);
                break;
    ...
    private void rotate0(int x, int y){
        ...
        if(canRotate){
            ...
            setJPar2Location(new Point(TetrisForm.setPlayGroundCoord(x+1,y)));
            setJPar3Location(new Point(TetrisForm.setPlayGroundCoord(x+2,y)));             
        }
